...
* **`Titanic\_Survival\_Prediction.ipynb`**: Complete Jupyter Notebook featuring data preprocessing, feature engineering, exploratory visualizations, machine learning model training, hyperparameter tuning, and metric evaluation.
...
* `01\_survival\_distribution.png` - Overall survival pie \& bar chart
* `02\_survival\_by\_gender.png` - Gender comparison bar chart
* `03\_survival\_by\_pclass.png` - Passenger class survival chart
* `04\_age\_distribution\_by\_survival.png` - Age KDE density plot
* `05\_fare\_distribution\_by\_class.png` - Fare vs class boxplot
* `06\_survival\_by\_family\_size.png` - Family size survival analysis
* `07\_survival\_by\_title.png` - Title extraction survival rate
* `08\_correlation\_matrix.png` - Feature correlation heatmap
* `09\_model\_accuracy\_comparison.png` - Model benchmark comparison
* `10\_confusion\_matrix.png` - Confusion matrix heatmap
...
2. Open `Titanic\_Survival\_Prediction.ipynb` in Jupyter Notebook, VS Code, or Google Colab.
